...
import PreviewImg from '../../media/profile-baby-blue.png';

export default function IPhoneMockup ({ imgSrc }) {
    
    const loadImgToScreen = () => {

    }
    return (
        <svg id="iphone-mockup" xmlns="http://www.w3.org/2000/svg" width="814" height="1608" viewBox="0 0 814 1608">
        <defs>
        ...
        <g id="Group_7848" data-name="Group 7848" transform="translate(5137 3909)">
          ...
          <path id="screen" d="M141.992,0C146.712,0,152,5.288,152,10.008h0c0,24.179,19.49,44.064,46,44.064H492c26.51,0,44-15.859,44-44.064h0C536,5.285,541.284,0,546.008,0H620a70.047,70.047,0,0,1,70,70.094V1423.906A70.047,70.047,0,0,1,620,1494H70a70.047,70.047,0,0,1-70-70.094V70.094A70.047,70.047,0,0,1,70,0Z" transform="translate(-5075 -3852)" fill={`url#{imgSrc}`} />
        </g>
      </svg>        
    )
}
